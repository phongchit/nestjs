...
import { reservation, restaurant, table, user_restaurant, zone_table, } from 'src/entities';

@Module({
  imports: [
    TypeOrmModule.forFeature([user_restaurant, restaurant, zone_table, table, reservation]),
  ],
